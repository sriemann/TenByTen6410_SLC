...
BOOL    DM9000AInit(PBYTE iobase, DWORD membase, USHORT MacAddr[3]);
UINT16  DM9000AGetFrame(PBYTE pbData, UINT16 *pwLength);
UINT16  DM9000ASendFrame(PBYTE pbData, DWORD dwLength);
