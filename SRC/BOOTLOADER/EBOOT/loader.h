...
#define LOGO_BLOCK_SIZE             20 // we need 18 for 1024x768 RGB BMP
#define LOGO_SECTOR                 BLOCK_TO_SECTOR(LOGO_BLOCK) 
#define LOGO_SECTOR_SIZE			BLOCK_TO_SECTOR(1)*LOGO_BLOCK_SIZE
//----------------------------- end --------------------------------------- 
...
extern void VIC_InterruptEnable(UINT32 intNum);
extern void VIC_InterruptDisable(UINT32 intNum);
