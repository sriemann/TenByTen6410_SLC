...
// BOOT_MODE_ flags indicate where we are booting from
#define USB_OPTION_ON       0x00100000
#define USB_OPTION_OFF      0x00200000
...
extern BOOL TOC_Init(DWORD dwEntry, DWORD dwImageType, DWORD dwImageStart, DWORD dwImageLength, DWORD dwLaunchAddr);
extern BOOL TOC_Read(void);
extern BOOL TOC_Write(void);
extern void TOC_Print(void);
